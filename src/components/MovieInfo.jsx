...
const MovieInfo = ({ id, title, poster, stars, overview, length, genres, budget, revenue, production }) => {
    ...
    useEffect(() => {
        axios.get(`https://api.themoviedb.org/3/movie/${id}/external_ids?api_key=b28a6d7a756aac4ded04e3b860e94284&language=es`)
            .then(res => {
                setExternalIds(res.data.results);
            }).catch(error => console.log(error))
    }, []);

    useEffect(() => console.log(externalIds), [externalIds]);
            ...
            <div className="container-movie">
                ...
                <div className="container-text">
                    ...
                    <div className="links">
                        ...
                        <a href="https://www.twitter.com/oldguardmovie">
                            <svg viewBox="0 0 512 512" aria-hidden="true" focusable="false" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className="icon twitter">
                        ...
                        <a href="https://www.facebook.com/oldguardmovie">
                            <svg viewBox="0 0 448 512" aria-hidden="true" focusable="false" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className="icon facebook">
                        ...
                        <a href="https://www.instagram.com/oldguardmovie">
                            <svg viewBox="0 0 448 512" aria-hidden="true" focusable="false" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className="icon instagram">
                        ...
                        <a href="https://www.netflix.com/title/81038963">
                            <svg viewBox="0 0 512 512" aria-hidden="true" focusable="false" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className="icon netflix">
