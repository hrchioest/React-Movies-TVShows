...
const TvInfo = ({information: {name, poster_path, vote_average, overview, episode_run_time, genres, number_of_seasons, number_of_episodes, production_companies}}) =>{
            ...
            <div className="container-movie">
                ...
                <div className="container-text">
                    ...
                    <p className="duration-movie mgn-top">
                        Temporadas: {number_of_seasons}</p>
                    <p className="gender-movie mgn-top">Episodios:{number_of_episodes}</p>
                    <p className="budget-movie mgn-top">Duración: {episode_run_time} min.</p>
