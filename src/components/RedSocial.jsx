...
const RedSocial = ({ id }) => {
  ...
  useEffect(() => {
    axios
      .get(
        `https://api.themoviedb.org/3/movie/${id}/external_ids?api_key=b28a6d7a756aac4ded04e3b860e94284&language=es`
      )
      .then((res) => {
  ...
  return (
    <div className='links'>
      ...
      {socialMedia.netflix_id ? (
        <a href={`https://www.netflix.com/title/${socialMedia.netflix_id}`}>
          <svg
            viewBox='0 0 512 512'
            aria-hidden='true'
            focusable='false'
