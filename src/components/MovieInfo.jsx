            ...
            <div className="all">
                <div className="container-movie">
                    ...
                    <div className="container-text">
                        ...
                        <h2 className="title-movie">{id}</h2>
                        <div className="rating-movie">
                            
                        </div>
    
                        <p className="description-movie">aaa</p>
                        <p className="duration-movie mgn-top">Duración: aaaa min.</p>
                        <p className="gender-movie mgn-top">Géneros:
                        aaaaaaaaaaaaaa
                        </p>
                        <p className="budget-movie mgn-top">Presupuesto: $aaaaa</p>
                        <p className="collect-movie mgn-top">Recaudación: $aa</p>
                        <p className="produ-movie mgn-top">Producción: aaa</p>
